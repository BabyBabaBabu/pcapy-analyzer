...
def DNSTraffic(pkts) :
	...
	for pkt in pkts:
		...
		if (pkt.haslayer(DNS)) and (pkt.payload.dport == 53):
			dns = (pkt.getlayer(DNS).qd.qname).decode('utf-8')
...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="pcapy-analyzer.py - A PCAP File analyzer based on Scapy - the interactive packet manipulation tool")
